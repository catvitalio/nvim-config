return function()
  ...
  local colors = {
    ...
    -- Lualine
    lualine_a_normal = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_a_insert = { fg = '#4ec9b0', bg = '#1f1f1f' },
    lualine_a_visual = { fg = '#c586c0', bg = '#1f1f1f' },
    lualine_a_replace = { fg = '#f44747', bg = '#1f1f1f' },
    lualine_b_normal = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_b_insert = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_b_visual = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_b_replace = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_c_normal = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_c_insert = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_c_visual = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_c_replace = { fg = '#d4d4d4', bg = '#1f1f1f' },
    ...
    lualine_y_normal = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_y_insert = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_y_visual = { fg = '#d4d4d4', bg = '#1f1f1f' },
    lualine_y_replace = { fg = '#d4d4d4', bg = '#1f1f1f' },
